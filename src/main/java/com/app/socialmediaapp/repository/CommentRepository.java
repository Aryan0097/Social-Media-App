...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query(value = "select 'commented on', c.post_id, u.image, u.username from"
    + "comment c left join user u on u.id=c.user_id where c.post_id in :postIds limit 5",nativeQuery=true)
